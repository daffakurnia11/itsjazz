...
class ShortlinkController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/shortlink')->with('notif', "Link created");
    }
    ...
    {
        return view('admin.shortlink.edit', [
            'title'     => 'Ubah Short Link',
            'shortlink' => $shortlink
        ]);
    }
    ...
    public function update(Request $request, Shortlink $shortlink)
    {
        ...
        return redirect('/admin/shortlink')->with('notif', "Link updated");
    }
    ...
    public function destroy(Shortlink $shortlink)
    {
        ...
        return redirect('/admin/shortlink')->with('notif', "Link deleted");
    }
}
